      ...
      <Box className={classes.component}>
        ...
        <FormControl component="fieldset">
          ...
          >
            <FormControlLabel
              value="M"
              control={<Radio style={{ color: "#0802A3" }} />}
              label="Male"
              disabled={!isEditPInfo}
            />
            <FormControlLabel
        ...
        <Box>
          <div style={{ margin: "50px 0" }}>
            ...
            <div>
              ...
              <br />
              <h4>
                When will my ShopSavvy account be updated with the new email
              ...
              <br />
              <h4>
                What happens to my existing ShopSavvy account when I update my
                email address (or mobile number)?
              </h4>
              <p>
              ...
              <p>
              ShopSavvy has a 'single sign-on' policy. Any changes will reflect
